...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			// Memory management panel, registered into the details-tabs container
			// (dsh-details-tabs owns the `details` slot and renders keyed child
			// panels from `details.tabs.item`). Key + label make it a tab.
